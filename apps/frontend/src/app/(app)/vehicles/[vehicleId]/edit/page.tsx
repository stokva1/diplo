...
export default function EditVehiclePage() {
    ...
    useEffect(() => {
        async function loadFormData() {
            ...
            try {
                const [vehicleResponse, membersResponse] = await Promise.all([
                    apiRequest<VehicleDetail>(`/vehicles/${vehicleId}`, {token}),
                    apiRequest<MembersResponse>(
                ...
                setForm({
                    ...
                    fuelType: vehicleResponse.fuelType,
                    currentOdometerKm: String(vehicleResponse.currentOdometerKm),
                    vin: vehicleResponse.vin ?? "",
                    managerMemberId: vehicleResponse.manager?.id ?? "",
                    note: vehicleResponse.note ?? "",
                });
            } catch (error) {
                setError(
    ...
    return (
        <div className="mx-auto max-w-3xl">
            ...
            <div className="mb-6">
                <PageHeader
                    title="Edit vehicle"
                    description="Update vehicle details and assigned manager."
                />
            </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="mt-0.5 text-sm text-muted-foreground">
                                Update identification, fuel and management information.
                            </p>
                        </div>
                    </div>
                </div>
